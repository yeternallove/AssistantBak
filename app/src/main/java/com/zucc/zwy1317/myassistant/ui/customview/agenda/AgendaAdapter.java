...
import com.zucc.zwy1317.myassistant.ui.customview.render.DefaultEventRenderer;
import com.zucc.zwy1317.myassistant.ui.customview.render.EventRenderer;
...
public class AgendaAdapter extends BaseAdapter implements StickyListHeadersAdapter {
    ...
    /**
     * CalendarEventBean 事件集合
     */
    private List<CalendarEventBean> mEvents = new ArrayList<>();
     ...
     * @param events 事件集合
     */
    public void updateEvents(List<CalendarEventBean> events) {
        this.mEvents.clear();
    ...
    @Override
    public CalendarEventBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final CalendarEventBean event = getItem(position);
